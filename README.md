...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pandas-dev-flaker-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15098&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pandas-dev-flaker-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pandas-dev-flaker` can be installed with:

```
conda install pandas-dev-flaker
```

It is possible to list all of the versions of `pandas-dev-flaker` available on your platform with:
